...
import YTLogo2 from "../../assets/yt-logo2.webp";
...
const workData = [
  {
    ...
    codeLink:
      "https://github.com/ChristopherStephenLewis/facerecognitionwebsite",
  },
  {
    img: YTLogo2,
    title: "YouTube Clone",
    demoLink: "https://yt-web-client-pziekzs4da-uc.a.run.app/",
    codeLink: "https://github.com/ChristopherStephenLewis/youtube-clone",
  },
];
...
const Work = () => {
  return (
    <div
      className="bg-[#0a192f] w-full md:h-screen text-gray-300 scroll-mt-12"
      id="work"
    >
      <div className="flex flex-col justify-center w-full h-full max-w-4xl p-4 mx-auto">
        <div className="pb-8">
          ...
          <p className="py-4 text-xl">
            ...
            <span className="text-[#00a0ea]">recent work</span>:
          </p>
        </div>
